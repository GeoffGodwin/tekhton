...
emit_dashboard_diagnosis() {
    ...
    _diagnose_write_js_file "${dash_dir}/data/diagnosis.js" "TK_DIAGNOSIS" "$json"
}

# _diagnose_write_js_file FILEPATH VARNAME JSON_CONTENT
# Minimal atomic JS-data file writer. m33.2 inlined this from the deleted
# lib/dashboard_parsers.sh:_write_js_file so the bash diagnose path still
# emits diagnosis.js without re-introducing the parser file.
