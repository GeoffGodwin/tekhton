...
#
# Delta-based updates to existing ${DESIGN_FILE} and CLAUDE.md based on accumulated
...
# Approval menu + delta apply/archive helpers extracted to
# replan_brownfield_apply.sh to keep this file under the 300-line ceiling.
# Provides: _brownfield_approval_menu, _apply_brownfield_delta,
#           _archive_replan_delta
# shellcheck source=replan_brownfield_apply.sh disable=SC1091
source "$(dirname "${BASH_SOURCE[0]}")/replan_brownfield_apply.sh"
