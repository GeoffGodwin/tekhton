...
#
# m12: extracted from lib/orchestrate.sh as part of the bash relocation
# cutover. lib/orchestrate.sh is now a ≤60-line shim that just sources its
# dependencies; the actual outer orchestration loop body lives here.
#
