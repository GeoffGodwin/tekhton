...
archive_reports() {
    ...
    for f in CODER_SUMMARY.md REVIEWER_REPORT.md TESTER_REPORT.md JR_CODER_SUMMARY.md SECURITY_REPORT.md SECURITY_NOTES.md INTAKE_REPORT.md PREFLIGHT_ERRORS.md TEST_AUDIT_REPORT.md; do
        if [ -f "$f" ]; then
