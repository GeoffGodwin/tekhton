...
complete -c tekhton -l migrate-dag -d 'Convert inline milestones to DAG format'
...
complete -c tekhton -l with-notes -d 'Force human notes injection'
complete -c tekhton -l usage-threshold -d 'Pause if session usage exceeds N%'
complete -c tekhton -l add-milestone -d 'Create a scoped milestone'
complete -c tekhton -l fix-nonblockers -d 'Address all open non-blocking notes'
complete -c tekhton -l fix-nb -d 'Address all open non-blocking notes'
complete -c tekhton -l fix-drift -d 'Force drift audit + resolution'
