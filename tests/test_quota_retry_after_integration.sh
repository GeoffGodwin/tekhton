...
# We need _extract_retry_after_seconds; the helper lives in agent_retry.sh.
# That file pulls in monitoring machinery via a chain of sourced files; to
# avoid those dependencies we inline the helper here — same definition.
