...
- [x] [BUG] Watchtower Actions screen: Cannot add new Parallel Groups, only existing ones are selectable. New projects have only one (or zero) options available
- [x] [BUG] Watchtower: Live Run page uses minimal screen real estate and should be a persistent banner at the top of every page instead of its own page
