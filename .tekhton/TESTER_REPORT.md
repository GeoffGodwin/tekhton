...
- [x] `tests/test_wedge_audit.sh` — wedge-audit.sh: clean HEAD exits 0, violation patterns detected, allowlist files exempt, report names offending file
